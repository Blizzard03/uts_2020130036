...
import 'package:uts_2020130036/services/l10n/app_localizations_ina.dart';
import 'package:uts_2020130036/services/l10n/app_localizations_jp.dart';
import 'package:uts_2020130036/services/l10n/app_localizations_su.dart';
...
abstract class AppLocalizations {
  ...
  /// No description provided for @bao.
  ///
  /// In en, this message translates to:
  /// **'Business and Office'**
  String get bao;
  ...
  ///
  /// In en, this message translates to:
  /// **'Neko Shop is the best place for all your laptop needs'**
  String get motto;

  /// No description provided for @theIntroText.
  ///
  /// In en, this message translates to:
  /// **'The best place to find the perfect laptop. Whether you need a powerful gaming laptop, a sleek and portable ultrabook, or an affordable notebook, we have it all.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Discover hot laptop sales this week.'**
  String get discover;
  ...
  /// No description provided for @Neko Shop.
  ///
  /// In en, this message translates to:
  /// **'Neko Shop'**
  String get nekoShop;
  ...
  /// No description provided for @ariqRasyid.
  ///
  /// In en, this message translates to:
  /// **'Muhamad Ariq Rasyid'**
  String get ariqRasyid;
...
AppLocalizations lookupAppLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    ...
    case 'ina':
      return AppLocalizationsINA();
    case 'jp':
      return AppLocalizationsJp();
  }
