...
import 'package:uts_2020130036/models/review_model.dart';
...
class Product implements Comparable<Product> {
  ...
  factory Product.fromJson(Map<String, Object?> json) => Product(
        ...
        review: (json["review"] as List)
            .map<Review>(
                (json) => Review.fromJson(json as Map<String, Object?>))
            .toList(),
  ...
  int get hashCode => Object.hash(id, name, desc, createdAt, modifyAt, images,
      sku, category, price, review, isFavorite, totalQuantity);

  @override
  String toString() {
    return 'Product{id: $id, name: $name, desc: $desc, createdAt: $createdAt, modifyAt: $modifyAt, images: $images, sku: $sku, category: $category, price: $price, review: $review, isFavorite: $isFavorite, totalQuantity: $totalQuantity}';
  }
